    ...
    <div className="min-h-screen pt-20">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="max-w-md mx-auto">
            <div className="bg-gray-50 rounded-lg p-6 text-center">
              ...
              <a href="mailto:info@obayi.co" className="text-blue-600 hover:underline">
                info@obayi.co
              </a>
            </div>
          </div>
      ...
      <section className="py-12 bg-gray-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <div className="flex items-start">
                ...
                <div className="ml-3">
                  ...
                  <p className="mt-2 text-gray-600">
                    We allocate 98% of donations directly to our programs supporting education in Africa.
                    The remaining 2% covers essential administrative costs and fundraising efforts.
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="mt-8 bg-orange-50 rounded-lg p-6 border border-orange-100 max-w-3xl mx-auto">
            <div className="flex">
              ...
              <div>
                ...
                <p className="text-gray-600 mt-1">
                  ...
                  please email us directly at info@obayi.co
                </p>
              </div>
            </div>
          </div>
