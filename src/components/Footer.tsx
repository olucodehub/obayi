        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8'>
          ...
          <div>
            ...
            <p className='text-cyan-100 mb-4'>
              Empowering children in Africa through education and sustainable
              support.
            </p>
            <div className='flex space-x-4'>
              <a
                href='https://x.com/Obayi4Education?t=Grbu7vicrEWhaj793uCWrw&s=09'
                className='text-cyan-200 hover:text-white transition-colors'
              >
                <Twitter className='h-5 w-5' />
              </a>
              <a
                href='https://www.instagram.com/obayi4education/profilecard/?igsh=MWxmYmJmeGE0N2w3MA%3D%3D'
                className='text-cyan-200 hover:text-white transition-colors'
              >
