    ...
    <div className='bg-gray-50 py-12 px-4 sm:px-6 lg:px-8 rounded-lg'>
      <div className='max-w-lg mx-auto text-center'>
        ...
        <p className='text-gray-600 mb-8'>
          Join our newsletter to receive updates about our projects, success
        ...
        {isSubmitted ? (
          <div className='bg-green-50 p-4 rounded-md'>
            ...
            <p className='text-green-700 mt-2'>
              You'll start receiving updates from Obayi soon.
            </p>
          </div>
        ) : (
          <form onSubmit={handleSubmit} className='space-y-4'>
            ...
            <p className='text-xs text-gray-500 mt-2'>
              By subscribing, you agree to our privacy policy. We'll never share
              your information.
            </p>
          </form>
        )}
